    ...
    where TAggregate : IAggregateRoot<TId>
{
    ...
    Result.Result Add(TAggregate aggregate);
    ...
    /// <returns>A <see cref="Result.Result"/> indicating the outcome.</returns>
    Result.Result AddRange(ICollection<TAggregate> aggregates);
    ...
    /// <returns>A <see cref="Result.Result"/> indicating the outcome.</returns>
    Result.Result Remove(Expression<Func<TAggregate, bool>> filterExpression);
    ...
    /// <param name="filterExpression">An expression to filter the aggregates to be removed.</param>
    /// <returns>A <see cref="Result.Result"/> indicating the outcome.</returns>
    Result.Result RemoveRange(Expression<Func<TAggregate, bool>> filterExpression);
    ...
    /// <param name="cancellationToken">A <see cref="CancellationToken"/> to observe while waiting for the task to complete.</param>
    /// <returns>A <see cref="Task{TResult}"/> representing the asynchronous operation, containing a <see cref="Result.Result"/> indicating the outcome.</returns>
    Task<Result.Result> AddRangeAsync(ICollection<TAggregate> aggregates, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">A <see cref="CancellationToken"/> to observe while waiting for the task to complete.</param>
    /// <returns>A <see cref="Task{TResult}"/> representing the asynchronous operation, containing a <see cref="Result.Result"/> indicating the outcome.</returns>
    Task<Result.Result> UpdateAsync(TAggregate aggregate, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">A <see cref="CancellationToken"/> to observe while waiting for the task to complete.</param>
    /// <returns>A <see cref="Task{TResult}"/> representing the asynchronous operation, containing a <see cref="Result.Result"/> indicating the outcome.</returns>
    Task<Result.Result> RemoveAsync(Expression<Func<TAggregate, bool>> filterExpression, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">A <see cref="CancellationToken"/> to observe while waiting for the task to complete.</param>
    /// <returns>A <see cref="Task{TResult}"/> representing the asynchronous operation, containing a <see cref="Result.Result"/> indicating the outcome.</returns>
    Task<Result.Result> RemoveByIdAsync(TId id, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">A <see cref="CancellationToken"/> to observe while waiting for the task to complete.</param>
    /// <returns>A <see cref="Task{TResult}"/> representing the asynchronous operation, containing a <see cref="Result.Result"/> indicating the outcome.</returns>
    Task<Result.Result> RemoveRangeAsync(Expression<Func<TAggregate, bool>> filterExpression, CancellationToken cancellationToken = default);
